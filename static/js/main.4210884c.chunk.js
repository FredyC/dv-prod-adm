...
`,be=H.a`
  ...
  ${X.e}
`;var ge=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const ye=fe.named("OrderMap").actions(e=>({panToOrder(t){return ge(this,void 0,void 0,function*(){if(!e.mapRef)return;const{data:n}=yield e.client.query({query:be,variables:{orderId:t}});n&&n.order.gps&&e.mapRef.panTo(Object(de.b)(n.order.gps))})},panToBranch(t){return ge(this,void 0,void 0,function*(){const{data:n}=yield e.client.query({query:he,variables:{branchId:t}});e.mapRef&&n&&e.mapRef.panTo(Object(de.b)(n.companyBranch.gps))})}}));var ve=n(112),Ie=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const Ee=F.a.named("OrderState").views(e=>({})).actions(e=>({updateOrderState(t,n){return Ie(this,void 0,void 0,function*(){const r={orderId:t,state:n};yield e.client.mutate({mutation:ve.e,variables:r})})}})).actions(e=>({deliverOrder:t=>e.updateOrderState(t,re.d.ON_WAY),sendTimeNotification(t,n){return Ie(this,void 0,void 0,function*(){const r={orderId:t,minutes:n};yield e.client.mutate({mutation:ve.d,variables:r})})},selectDriver(t,n){return Ie(this,void 0,void 0,function*(){const r={orderId:t,driverId:n};yield e.client.mutate({mutation:ve.c,variables:r})})},removeDriver(t){return Ie(this,void 0,void 0,function*(){const n={orderDriverId:t};yield e.client.mutate({mutation:ve.b,variables:n})})}})),Oe=$.j.model("Order",{list:$.j.optional(le.a,{}),map:$.j.optional(ye,{}),state:$.j.optional(Ee,{})});var Ce=n(340),Ae=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const De=F.a.named("Statistics").props({branches:$.j.optional($.j.array($.j.string),[]),closureBranch:$.j.maybeNull($.j.string)}).volatile(e=>({dateFrom:new Date,dateTo:new Date})).views(e=>({get branchesFilter(){return e.branches.length>0?Array.from(e.branches):e.root.user.branchesId},get hasBranchFilter(){return e.branches.length>0}})).actions(e=>({updateFilter(t){e.dateFrom=new Date(t.dateFrom),e.dateTo=new Date(t.dateTo)},clearBranchFilter(){e.branches.clear()},setBranchFilter(t){e.branches.replace(t)},setClosureBranch(t){e.closureBranch=t},createClosure(){return Ae(this,void 0,void 0,function*(){if(e.closureBranch){const t={companyBranchId:e.closureBranch};return e.client.mutate({mutation:Ce.a,variables:t,refetchQueries:["GClosureReportQuery"]})}throw new Error("Tried to create a closure without branch selected")})}}));var Se=n(292);const Ne=F.a.named("SettingsBase").views(e=>({get settings(){return Object($.d)(e)}}));var Re=n(291),je=n(286),we=n(242),Te=n(100),$e=n(101),Pe=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const Le=Te.a.named("MenuStock").actions(e=>({createItem(t){const n={stockItem:Object.assign({companyBranch:e.branchId},Me(t))};return Object(O.b)(e.client.mutate({mutation:$e.a,variables:n,refetchQueries:[{query:we.a,variables:{branchId:e.branchId}}]}))},updateItem(t){const n={stockId:t.id,stockItem:Object.assign({},Me(t))};return Object(O.b)(e.client.mutate({mutation:$e.d,variables:n}))},deleteItem(t){return Pe(this,void 0,void 0,function*(){const n={stockId:t};yield e.client.mutate({mutation:$e.b,variables:n,refetchQueries:[{query:we.a,variables:{branchId:e.branchId}}]})})}}));function Me(e){return{code:e.code,label:e.nameLabel,note:e.note,plu:e.plu,allergens:e.allergens,wareUnit:e.wareUnit,allowNegative:e.allowNegative}}const Be=Ne.named("Menu").props({category:$.j.optional(Re.a,{}),recipe:$.j.optional(je.a,{}),stock:$.j.optional(Le,{})}),Ge=F.a.named("Settings").props({selectedBranchId:$.j.maybe($.j.string),businessHours:$.j.optional(Se.a,{}),menu:$.j.optional(Be,{})}).views(e=>({get branchId(){return e.selectedBranchId||Q.a.head(e.root.user.branchesId)},get queryProps(){const e=this.branchId;return e?{variables:{branchId:e}}:{skip:!0}},getQueryProps(e){const t=this.branchId;return t?{variables:Object.assign({branchId:t},e)}:{skip:!0}}})).actions(e=>({selectBranch(t){e.selectedBranchId=t}}));var Fe=n(122),_e=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const ke=fe.named("ZoneMap").volatile(()=>({currentZonePoints:null})).actions(e=>({updateZonePoints(t){e.currentZonePoints=t},clearZonePoints(){e.currentZonePoints=null},panToZone(t){return _e(this,void 0,void 0,function*(){const{data:n}=yield e.client.query({query:Fe.c,variables:{zoneId:t}});if(n){const{zone:{companyBranch:{gps:t}}}=n;e.mapRef&&e.mapRef.panTo(Object(de.b)(t))}})},panToBranch(t){return _e(this,void 0,void 0,function*(){e.mapRef&&e.mapRef.panTo(Object(de.b)(t.gps))})}})),Ue=H.a`
...
`;var Ze=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const qe=F.a.named("Zone").props({map:$.j.optional(ke,{}),brandId:$.j.maybeNull($.j.string)}).volatile(()=>({branch:null})).views(e=>({get brand(){return e.brandId&&e.root.user.brands.find(Q.a.propEq("id",e.brandId))||null},get hasBranchFilter(){return null!==e.branch},get branchFilterId(){return null===e.branch?null:e.branch.id},get branchFilterPredicate(){return null!==e.branch?K.propEq("id",e.branch.id):null===this.brand?()=>!1:K.pathSatisfies(K.equals(this.brand.id),["brand","id"])},get zoneFilterPredicate(){return null!==e.branch?K.pathSatisfies(K.equals(e.branch.id),["companyBranch","id"]):null===this.brand?()=>!1:K.pathSatisfies(K.equals(this.brand.id),["companyBranch","brand","id"])},get branches(){return e.root.user.isReady?e.root.user.branches:[]}})).actions(e=>({setBranchFilter(t){e.branch=t,e.brandId=t.brand.id,e.map.panToBranch(t)},setBrandFilter(t,n){e.brandId=t.id,e.branch&&e.branch.brand.id===t.id||(e.branch=1===n.length&&Q.a.head(n)||null)},clearBranchFilter(){e.branch=null},clearBrandFilter(){e.brandId=null,e.branch=null}})).actions(e=>({createZone:Object($.b)(function*(t){if(null===e.branch)throw new I.VError("Called createZone without branch being set");const n=Object(de.a)({center:e.branch.gps,metersRadius:1e3,pointsCount:5}),r={branchId:e.branch.id,points:n},{data:a}=yield e.client.mutate({mutation:Ue,variables:r,updateQueries:{GZones:(e,{mutationResult:t})=>{const n=t.data.createZone;return n?Object.assign({},e,{zones:e.zones.concat(n)}):e}}});if(a){t(a.createZone.id)}}),saveZone(t,n){return Ze(this,void 0,void 0,function*(){const r={zoneId:t,update:{name:n.name,enabled:n.enabled,companyBranch:n.companyBranch.id,zoneColor:n.zoneColor.id,minimalOrderPrice:{value:Number(n.minimalOrderPrice.value)||0},priceRangeRules:n.priceRangeRules.map(Ye).filter(K.reject(K.pathEq(["price","value"],null))),geoPolygon:e.map.currentZonePoints||void 0}};yield e.client.mutate({mutation:xe,variables:r,updateQueries:{GZones:(e,{mutationResult:n})=>{const r=e.zones.findIndex(K.propEq("id",t)),a=n.data.updateZone;return Object.assign({},e,{zones:K.update(r,a,e.zones)})}}}),e.map.clearZonePoints()})},destroyZone(t){if(!t)return;const n={zoneId:t};e.client.mutate({mutation:ze,variables:n,updateQueries:{GZones:e=>Object.assign({},e,{zones:K.reject(K.propEq("id",t),e.zones)})}})},changeZonePriority:Object($.b)(function*(t,n,r){if(!t||n===r)return;const a=n-r,o={zoneId:t.id,offset:a};yield e.client.mutate({mutation:He,variables:o,optimisticResponse:{__typename:"Mutation",updateZonePriority:{__typename:"Zone",id:t.id,priority:t.priority+a}}})})}));function Ve(e){if(null===e)return null;const t=Number(e);return Number.isNaN(t)?null:t}function Ye(e){return{price:{value:Ve(e.price.value)},toPrice:{value:Ve(e.toPrice.value)||-1}}}const We=F.a.named("Root").props({auth:$.j.optional(q,{}),user:$.j.optional(ne,{}),order:$.j.optional(Oe,{}),createOrder:$.j.optional(ce,{}),zone:$.j.optional(qe,{}),settings:$.j.optional(Ge,{}),config:$.j.optional(V,{}),statistics:$.j.optional(De,{})}).views(e=>({get persistedModels(){return[e.auth,e.user,e.settings,e.zone,e.order,e.statistics]}}));var Ke=n(53);n.d(t,"a",function(){return Xe}),n.d(t,"d",function(){return et}),n.d(t,"c",function(){return tt}),n.d(t,"b",function(){return nt});var Qe=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const Je=Object(a.createContext)(void 0),Xe=({children:e})=>{const[t,n]=Object(a.useState)(void 0);return(e=>{Object(a.useEffect)(()=>{e()},[])})(()=>Qe(void 0,void 0,void 0,function*(){const e=q.create({}),t=j(e),r=We.create({auth:e},{fetch:window.fetch,apolloClient:t});yield Promise.all(r.persistedModels.map(M)),yield r.user.initUser(),n(r)})),t?o.a.createElement(Je.Provider,{value:t.client},o.a.createElement(i.ApolloProvider,{client:t.client},o.a.createElement(c.a,{client:t.client},o.a.createElement(s.Provider,{value:t},a.Children.only(e))))):o.a.createElement(Ke.a,null)},et=()=>{const e=Object(a.useContext)(s);if(!e)throw new Error("RootProvider missing in the tree");return e},tt=()=>{const e=Object(a.useContext)(Je);if(!e)throw new Error("ApolloContext.Provider missing in the tree");return e},nt=({children:e,observe:t=!0})=>{const n=et();return!0===t?o.a.createElement(r.a,null,()=>e(n)):e(n)}},51:function(e,t,n){"use strict";n.d(t,"a",function(){return i});var r=n(0),a=n.n(r),o=n(50);const i=({render:e,observe:t})=>a.a.createElement(o.b,{children:e,observe:t})},52:function(e,t,n){"use strict";n.d(t,"b",function(){return a}),n.d(t,"c",function(){return o}),n.d(t,"a",function(){return i});var r=n(256);const a=e=>({lat:Number(e.latitude),lng:Number(e.longitude)}),o=e=>({latitude:Number(e.lat()),longitude:Number(e.lng())}),i=({center:e,metersRadius:t=1e3,pointsCount:n=15})=>new Array(n).fill(null).map((a,o)=>{const i=360/n*o;return Object(r.computeDestinationPoint)(e,t,i)})},53:function(e,t,n){"use strict";var r=n(0),a=n.n(r),o=n(487),i=n.n(o),c=n(9);t.a=(({noMargin:e=!1})=>a.a.createElement("div",{style:{display:"flex",alignSelf:"center",justifyContent:"center"}},a.a.createElement(i.a,{name:"pacman",style:e?{}:{marginTop:"45vh",color:c.a.orange}})))},58:function(e,t,n){"use strict";n.d(t,"c",function(){return i}),n.d(t,"e",function(){return c}),n.d(t,"a",function(){return s}),n.d(t,"d",function(){return u}),n.d(t,"b",function(){return l});var r=n(3),a=n.n(r),o=n(38);const i=a.a`
...
//# sourceMappingURL=main.4210884c.chunk.js.map