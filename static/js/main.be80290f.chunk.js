...
`,s=a.a`
  ...
  ${c}
`,u=Object(o.a)(s)},18:function(e,t,n){"use strict";n.d(t,"g",function(){return o}),n.d(t,"b",function(){return i}),n.d(t,"c",function(){return c}),n.d(t,"i",function(){return s}),n.d(t,"h",function(){return u}),n.d(t,"a",function(){return l}),n.d(t,"e",function(){return d}),n.d(t,"d",function(){return p}),n.d(t,"j",function(){return m}),n.d(t,"f",function(){return f});var r=n(21),a=n.n(r);const o=a()("main"),i=a()("debug"),c=a()("error"),s=(a()("auth"),a()("routing")),u=a()("persistence"),l=a()("bootstrap"),d=(a()("access"),a()("graph")),p=a()("form"),m=a()("sentry"),f=a()("lang");console.log},239:function(e,t,n){"use strict";n.d(t,"a",function(){return c}),n.d(t,"b",function(){return s});var r=n(3),a=n.n(r),o=n(32),i=n(58);const c=a.a`
...
`,s=Object(o.a)(i)},37:function(e,t,n){"use strict";var r=n(194),a=n(82),o=n(165),i=n(60),c=n(0),s=n.n(c),u=n(54),l=n(52),d=n(18),p=n(83),m=n.n(p),f=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const h={en:"en-gb"};n.d(t,"d",function(){return g}),n.d(t,"a",function(){return I}),n.d(t,"c",function(){return E}),n.d(t,"b",function(){return O});var b=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const g=Object(r.setupI18n)(),y="en",v=["cs","sk","en"],I=Object(i.b)(({children:e})=>{const{user:t}=Object(l.c)();return t.language?s.a.createElement(a.I18nProvider,{language:t.language,i18n:g},s.a.Children.only(e)):s.a.createElement(u.a,null)});function E(){const e=new o.LocaleResolver([new o.NavigatorDetector],[new o.LanguageOnlyTransformer]).getLocales();return Object(d.f)("detected languages %s",e.join("; ")),e.find(e=>v.includes(e))||y}function O(e){return b(this,void 0,void 0,function*(){return v.includes(e)?(yield function(e){return b(this,void 0,void 0,function*(){let t;t=yield n(6069)(`./${e}/messages.ts`),g.load({[e]:t}),Object(d.f)("loaded catalog %s",e)})}(e),g.activate(e),yield function(e){return f(this,void 0,void 0,function*(){yield n(6068)(`./${h[e]||e}`),m.a.locale(h[e]||e)})}(e),Object(d.f)("changed to %s",e),!0):(Object(d.f)("language %s is not supported"),!1)})}},38:function(e,t,n){"use strict";var r=n(3),a=n.n(r);const o=a.a`
...
`;var Z=function(e,t,n,r){return new(n||(n=Promise))(function(a,o){function i(e){try{s(r.next(e))}catch(t){o(t)}}function c(e){try{s(r.throw(e))}catch(t){o(t)}}function s(e){e.done?a(e.value):new n(function(t){t(e.value)}).then(i,c)}s((r=r.apply(e,t||[])).next())})};const q=F.a.named("Auth").props({userId:T.j.optional(T.j.string,""),token:T.j.optional(T.j.string,""),provider:T.j.optional(k,{})}).volatile(e=>({tokenForPasswordChange:""})).views(e=>({get isAuthenticated(){return e.token.length>0},get isAuthenticatedUser(){return this.isAuthenticated&&e.userId.length>0},get communicationToken(){return e.tokenForPasswordChange||e.token},get canCommunicate(){return this.isAuthenticated||e.tokenForPasswordChange.length>0}})).actions(e=>({authenticate(t,n){e.token=t,e.userId=n,e.tokenForPasswordChange="",e.log("authenticated with id %s",n),Object(G.a)(n)},invalidate(){e.token="",e.userId="",e.tokenForPasswordChange="",e.client.cache.reset(),e.log("invalidated authentication"),Object(G.a)(null)}})).actions(e=>({setForPasswordChange(t){e.invalidate(),e.tokenForPasswordChange=B.Base64.decode(t),e.log("using temp token %s",e.tokenForPasswordChange)},changePassword(t){return Z(this,void 0,void 0,function*(){const n={password:t},r=yield e.client.mutate({mutation:z,variables:n,fetchPolicy:"no-cache"}),{updateUserPassword:{id:a,token:o}}=r.data;o&&a&&(e.invalidate(),e.authenticate(o,a))})}})).preProcessSnapshot(e=>(e.userId&&Object(G.a)(e.userId),e)),V=F.a.named("Config").props({soundEnabled:!0,orderListPollIntervalSec:60,orderListSoundIntervalSec:60}),Y=T.j.model("Timing",{bySecond:T.j.optional(T.j.number,1/0),byMinute:T.j.optional(T.j.number,1/0),autoStart:!0}).actions(e=>({updateBySecond(t){(e.bySecond===1/0||t-e.bySecond>=1e3)&&(e.bySecond=t)},updateByMinute(t){(e.byMinute===1/0||t-e.byMinute>=6e4)&&(e.byMinute=t)}})).extend(e=>{let t=-1,n=Date.now;const r=()=>{const a=n();e.updateBySecond(a),e.updateByMinute(a),t=window.setTimeout(r,1e3)};return{actions:{start(e){e&&(n=e),r()},stop(){t>=0&&(window.clearTimeout(t),t=-1)}}}}).actions(e=>({afterAttach(){e.autoStart&&e.start()}}));var W=n(80),K=n.n(W),Q=n(24),J=n(13),X=n(37),ee=n(38);const te=H.a`
